...
const ColorLebalPickerComponent = ({ data, handleChange }: any) => {
  ...
  const handleColorChange = (color: any) => {
    ...
    setColorState((prev: any) => ({ ...prev, colorLabel: color.hex }));
  };
...
const ColorLebalPicker = withJsonFormsControlProps(ColorLebalPickerComponent);
export default ColorLebalPicker;
