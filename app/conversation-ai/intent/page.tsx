...
import {Grid,AccountTreeIcon,DeleteIcon,LoadingButton,useTheme,Switch,makeStyles, FormControlLabel, Box, Button, Typography, Accordion} from '../../Components/muiIcons/muiIcons';
        ...
        <Grid item xs={12} lg={6}>
          ...
          <Grid container sx={{marginTop:'10px'}}>
            ...
            <LoadingButton
              ...
              onClick={() =>
                sendJson({
                  api: "http://164.52.200.229:9484/intent",
