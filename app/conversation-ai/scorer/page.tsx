...
import {Grid,AccountTreeIcon,DeleteIcon,LoadingButton,useTheme,Switch,makeStyles, FormControlLabel, Box, Button, Typography, PersonSearchIcon, ScoreboardIcon, Accordion} from '../../Components/muiIcons/muiIcons';
        ...
        <div className={classes.dataContent}>
          ...
          <Grid container sx={{marginTop:'10px'}}>
            ...
            <LoadingButton
              ...
              onClick={() =>
                sendJson({
                  api: "http://164.52.200.229:9485/t_scorer",
                  // api: "https://dummy.restapiexample.com/api/v1/create",
            ...
            {apiResponse && (
              <ResponseModal>
                ...
                {/* Table here */}
                <OutputTable apiResponse={apiResponse} />
              </ResponseModal>
            )}
          </Grid>
        </Grid>
